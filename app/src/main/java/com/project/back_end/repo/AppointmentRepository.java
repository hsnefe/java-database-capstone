...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
   ...
   @Query("SELECT a FROM Appointment a LEFT JOIN FETCH a.patient WHERE a.doctor.id = :doctorId AND a.patient.name LIKE %:patientName% AND a.appointmentTime BETWEEN :start AND :end")
